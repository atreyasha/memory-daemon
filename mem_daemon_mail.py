...
if __name__ == "__main__":
    ...
    requiredNamed.add_argument('--port', help='smtp port', type=int,
                               required=True)
    requiredNamed.add_argument('--text', help='raw message to send',
                               required=True)
    requiredNamed.add_argument('--threshold', help='RAM threshold',
                               required=True)
